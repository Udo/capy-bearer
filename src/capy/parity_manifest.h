...
inline constexpr std::array<Evidence, 230> supported{{
    ...
    {"type/dvalue","site/doc/pages/type/dvalue.txt",":example capy render"},
    {"clear","site/doc/pages/clear.txt",":example capy render"},
    {"delete","site/doc/pages/delete.txt",":example capy render"},
    {"get","site/doc/pages/get.txt",":example capy render"},
    {"get_by_path","site/doc/pages/get_by_path.txt",":example capy render"},
    {"get_or_create","site/doc/pages/get_or_create.txt",":example capy render"},
    {"get_type_name","site/doc/pages/get_type_name.txt",":example capy render"},
    {"has","site/doc/pages/has.txt",":example capy render"},
    {"is_array","site/doc/pages/is_array.txt",":example capy render"},
    {"is_list","site/doc/pages/is_list.txt",":example capy render"},
    {"keys","site/doc/pages/keys.txt",":example capy render"},
    {"pop","site/doc/pages/pop.txt",":example capy render"},
    {"push","site/doc/pages/push.txt",":example capy render"},
    {"set","site/doc/pages/set.txt",":example capy render"},
    {"values","site/doc/pages/values.txt",":example capy render"},
