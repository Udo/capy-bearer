...
inline constexpr std::array<Evidence, 259> supported{{
    ...
    {"to_lower","site/tests/capy-coreutil.capy","to_lower("},
    {"to_upper","site/tests/capy-coreutil.capy","to_upper("},
    ...
    {"to_bool","site/tests/capy-coreutil.capy","to_bool("},
    {"to_f64","site/tests/capy-coreutil.capy","to_f64("},
    {"to_s64","site/tests/capy-coreutil.capy","to_s64("},
    {"to_u64","site/tests/capy-coreutil.capy","to_u64("},
    ...
    {"0_Request","site/tests/capy-request-parity.capy","request_base_url("},
    ...
    {"cli_arg","site/tests/capy-request-parity.capy","cli_arg("},
    {"cli_input","site/tests/capy-request-parity.capy","cli_input("},
    {"request_base_url","site/tests/capy-request-parity.capy","request_base_url("},
    {"request_context_params","site/tests/capy-request-parity.capy","request_base_url("},
    {"request_perf","site/tests/capy-request-parity.capy","request_perf("},
    {"request_query_path","site/tests/capy-request-parity.capy","request_query_path("},
    {"request_query_route","site/tests/capy-request-parity.capy","request_query_route("},
    {"request_route_from_raw_path","site/tests/capy-request-parity.capy","request_route_from_raw_path("},
    {"request_script_url","site/tests/capy-request-parity.capy","request_script_url("},
    ...
    {"ws_connections","site/tests/capy-websocket.capy","ws_connections("},
    {"ws_connection_count","site/tests/capy-websocket.capy","ws_connection_count("},
