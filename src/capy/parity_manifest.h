...
inline constexpr std::array<Evidence, 218> supported{{
    ...
    {"bool","site/doc/source/api/bool.txt",":example capy render"},
    {"s32","site/doc/source/api/s32.txt",":example capy render"},
    {"s64","site/doc/source/api/s64.txt",":example capy render"},
    {"u64","site/doc/source/api/u64.txt",":example capy render"},
    {"f64","site/doc/source/api/f64.txt",":example capy render"},
