...
- `miniz_tdef.c` moves the `s_tdefl_num_probes` initializer before its first use so the vendored C source can be included in UCE's single C++ translation-unit build.
