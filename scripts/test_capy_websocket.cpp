...
int main(){try{exchange(1,"hello",{{1,"echo:hello"},{1,"direct:hello"},{8,std::string("\x03\xe8",2)}});exchange(2,std::string("\0\xff" "capy",6),{{2,std::string("\0\xff" "capy",6)},{8,std::string("\x03\xe8",2)}});}catch(const std::exception& e){write(2,e.what(),std::strlen(e.what()));write(2,"\n",1);return 1;}return 0;}
