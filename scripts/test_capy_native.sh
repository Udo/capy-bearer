...
wasm-objdump -x "$BUILD_DIR/site_tests_capy-string-hostpath.capy.wasm" >"$BUILD_DIR/string-hostpath.objdump"
! grep -q 'env.bearer_text_parsing_brrb\|env.bearer_codec_archive_brrb\|env.bearer_string_nonblank' "$BUILD_DIR/string-hostpath.objdump"
...
CAPYC="$BUILD_DIR/capyc" scripts/benchmark_capy_compiler_scaling.sh
