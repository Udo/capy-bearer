...
- [ ] T3: Prove golden, reproducibility, and scaling gates on CT100 before adding them.
...
- [~] G3: Measure the staging gates and add passing gates.
...
1. Run golden, reproducibility, and repeated scaling checks in the CT100 staging clone.
