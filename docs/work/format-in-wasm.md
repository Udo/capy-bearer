...
- [x] G3: Replace the host float formatter with exact Capy bigint conversion.
...
- Use exact bigint conversion for the 17-significant-digit float output contract.
...
- 2026-08-31: Replaced the typed host `f64` formatter with exact Capy bigint conversion. Required outputs and sampled finite round trips pass. The formatter measures 7.45 to 8.20 microseconds per operation, which misses the 1 microsecond target.
